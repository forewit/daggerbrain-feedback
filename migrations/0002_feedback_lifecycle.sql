...
CREATE TABLE IF NOT EXISTS bug_preflight_sessions (
...
CREATE INDEX IF NOT EXISTS idx_bug_preflight_sessions_created_at
  ON bug_preflight_sessions (created_at DESC);
